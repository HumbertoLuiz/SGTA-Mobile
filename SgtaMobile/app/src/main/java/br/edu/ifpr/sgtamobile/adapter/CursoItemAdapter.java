...
public class CursoItemAdapter extends BaseAdapter {
    LayoutInflater mInflater;

    List<Curso> list;

    public CursoItemAdapter(Context c, List<Curso> mylist) {
