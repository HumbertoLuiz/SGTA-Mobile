...
public class ServidorItemAdapter extends BaseAdapter {
    LayoutInflater mInflater;

    List<Servidor> list;

    public ServidorItemAdapter(Context c, List<Servidor> mylist) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View v = mInflater.inflate(R.layout.layout_list_servidor, null);
