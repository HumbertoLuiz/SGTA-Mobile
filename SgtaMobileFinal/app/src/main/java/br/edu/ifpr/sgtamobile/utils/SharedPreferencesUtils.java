...
public class SharedPreferencesUtils {
    ...
    public static void write(SharedPreferences sp, SharedPreferences.Editor editor, Map<String, String> dtoLogin) {

        dtoLogin.entrySet().forEach(d -> editor.putString(d.getKey(), d.getValue()));
